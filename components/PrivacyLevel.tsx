    ...
    <div className="space-y-4 w-56 group">
      <div className="flex justify-between items-end">
        <div className="space-y-1">
          ...
          <p className="sans-ui text-[7px] text-[#C5A059]/40 italic">Active // Encrypted</p>
        </div>
        <span className="serif text-[12px] text-[#FFFFFF]/80 font-light tracking-[0.2em]">MAXIMUM</span>
      </div>
